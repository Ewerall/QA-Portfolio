...
1. **Смешение логики и GUI**  
   Класс `ModernCalculator` объединял бизнес-логику и графический интерфейс, что делало автотестирование невозможным без взаимодействия с окнами приложения.

2. **Проблемы автоматизации**  
   - Тестам требовалось закрывать всплывающие окна ошибок
   - GitHub Actions не поддерживает GUI-тестирование
...
Актуальные тесты [`calc_test_new.py`](https://github.com/Ewerall/CalcQA/blob/main/tests/calc_test_new.py) работают в пайплайне благодаря:
