...
| **Тест-дизайн**      | • Эквивалентное разделение (проверка групп значений) <br>• Анализ граничных значений (тестирование на границах диапазонов) <br>• Таблицы решений (комбинации условий/действий) <br>• Попарное тестирование (Pairwise) <br>• Предугадывание ошибок (Error Guessing)| 
